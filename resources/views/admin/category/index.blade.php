        ...
        <div class="container-fluid">
            <div class="row mb-2">
                ...
                <div class="col-2 mt-3">
                    <a type="button" href="{{ route('admin.category.create') }}" class="btn btn-block btn-primary">Create
                        category</a>
                </div>
            </div><!-- /.row -->
            {{-- table --}}
                            ...
                            <table class="table table-hover text-nowrap">
                                ...
                                @foreach($categories as $category)
                                    <tr>
                                        ...
                                        <td class="text-center" style="text-transform: capitalize;">{{ $category->title }}</td>
